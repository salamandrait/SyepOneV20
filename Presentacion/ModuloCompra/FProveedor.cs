...
namespace Presentacion.ModuloCompra
{
    public partial class FProveedor : Form
    {
        ...
        private static FProveedor _Instancia;

        public static FProveedor GetForm()
        {
            if (_Instancia == null)
            {
                _Instancia = new FProveedor();
            }
            return _Instancia;
        }
        ...
        private void Limpiar()
        {
            ...
            else
            {
                ...
                TxtCod_tipoproveedor.Text = string.Empty;
                TxtDesc_tipoproveedor.Text = string.Empty;
        ...
        public void Listar()
        {
            try
            {
                Ds = EProveedor.Listar();

                TxtCod_proveedor.Text = Ds.Tables[0].Rows[0]["Cod_proveedor"].ToString();
                TxtCod_proveedorv.Text = Ds.Tables[0].Rows[0]["Cod_proveedor"].ToString();
                TxtDesc_proveedor.Text = Ds.Tables[0].Rows[0]["Desc_proveedor"].ToString();
                ...
                TxtCod_tipoproveedor.Text = Ds.Tables[0].Rows[0]["Cod_tipoproveedor"].ToString();
                TxtDesc_tipoproveedor.Text = Ds.Tables[0].Rows[0]["Desc_tipoproveedor"].ToString();
        ...
        private void Guardar()
        {
            try
            {
                ...
                else
                {
                    if (TxtEditar.Text == "Nuevo")
                    {
                        Rpta = EProveedor.Insertar(TxtCod_proveedor.Text.Trim(), TxtDesc_proveedor.Text, TxtClasificacion.Text, TxtRif.Text, TxtContacto.Text, TxtDireccion.Text, TxtDireccion_alterna.Text, TxtCiudad.Text, TxtTelefono.Text, TxtMovil.Text, TxtCod_postal.Text, TxtWeb.Text, TxtEmail.Text, Convert.ToDecimal(TxtMontofiscal.Text), Convert.ToDecimal(TxtDescuentopp.Text), Convert.ToDecimal(TxtDescuentogb.Text), Convert.ToDecimal(TxtLimite_cred.Text), Convert.ToBoolean(TxtActivo.Text), Convert.ToBoolean(TxtNacional.Text), Convert.ToBoolean(TxtFiscal.Text), Convert.ToBoolean(TxtAplica_credito.Text), Convert.ToDateTime(TxtFecha_reg.Text), TxtCampo1.Text, TxtCampo2.Text, TxtCampo3.Text, TxtCampo4.Text, TxtCampo5.Text, TxtCampo6.Text, TxtCod_tipoproveedor.Text, TxtCod_segmento.Text, TxtCod_condicionpago.Text, TxtCod_cuentasie.Text, TxtCod_islr.Text, TxtCod_pais.Text, TxtCod_zona.Text);
                    }
                    else if (TxtEditar.Text == "Editar")
                    {
                        Rpta = EProveedor.Editar(TxtCod_proveedor.Text.Trim(), TxtCod_proveedorv.Text.Trim(), TxtDesc_proveedor.Text, TxtClasificacion.Text, TxtRif.Text, TxtContacto.Text, TxtDireccion.Text, TxtDireccion_alterna.Text, TxtCiudad.Text, TxtTelefono.Text, TxtMovil.Text, TxtCod_postal.Text, TxtWeb.Text, TxtEmail.Text, Convert.ToDecimal(TxtMontofiscal.Text), Convert.ToDecimal(TxtDescuentopp.Text), Convert.ToDecimal(TxtDescuentogb.Text), Convert.ToDecimal(TxtLimite_cred.Text), Convert.ToBoolean(TxtActivo.Text), Convert.ToBoolean(TxtNacional.Text), Convert.ToBoolean(TxtFiscal.Text), Convert.ToBoolean(TxtAplica_credito.Text), Convert.ToDateTime(TxtFecha_reg.Text), TxtCampo1.Text, TxtCampo2.Text, TxtCampo3.Text, TxtCampo4.Text, TxtCampo5.Text, TxtCampo6.Text, TxtCod_tipoproveedor.Text, TxtCod_segmento.Text, TxtCod_condicionpago.Text, TxtCod_cuentasie.Text, TxtCod_islr.Text, TxtCod_pais.Text, TxtCod_zona.Text);
                    }
                    ...
                    if (Rpta.Equals("Y"))
                    {
                        if (TxtEditar.Text == "Nuevo")
                        {
                            ...
                            TxtEditar.Text = "Listar";
                            TxtCod_proveedorv.Text = TxtCod_proveedor.Text;
                        }
                        else if (TxtEditar.Text == "Editar")
                        {
        ...
        private void GenerarCod()
        {
            try
            {
                int rpta = Convert.ToInt32(EProveedor.GenerarCod(TxtCod_proveedor.Text));
                TxtCod_proveedor.Text = Pref + rpta.ToString(TxtCadena.Text);
            }
            catch (Exception Ex)
            {
        ...
        internal void SetProveedor(string cod_proveedor, string desc_proveedor, string clasificacion, string rif, string contacto, string direccion, string direccion_alterna, string ciudad, string telefono, string movil, string cod_postal, string web, string email, string montofiscal, string descuentopp, string descuentogb, string limite_cred, string activo, string nacional, string fiscal, string aplica_credito, string fecha_reg, string campo1, string campo2, string campo3, string campo4, string campo5, string campo6, string cod_tipoproveedor, string desc_tipoproveedor, string cod_segmento, string desc_segmento, string cod_condicionpago, string desc_condicionpago, string diascredito, string cod_cuentasie, string desc_cuentasie, string cod_islr, string desc_islr, string cod_pais, string desc_pais, string cod_moneda, string desc_moneda, string cod_zona, string desc_zona)
        {
            ...
            TxtCod_tipoproveedor.Text = cod_tipoproveedor;
            TxtDesc_tipoproveedor.Text = desc_tipoproveedor;
        ...
        private void FProveedor_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }

        private void FProveedor_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void BtnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    Rpta = EProveedor.Eliminar(TxtCod_proveedor.Text);
        ...
        private void BtnAnterior_Click(object sender, EventArgs e)
        {
            try
            {
                Ds = EProveedor.Anterior(TxtCod_proveedor.Text);
        ...
        private void BtnSiguiente_Click(object sender, EventArgs e)
        {
            try
            {
                Ds = EProveedor.Siguiente(TxtCod_proveedor.Text);
        ...
        private void TxtCod_tipoproveedor_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
        ...
        private void TxtDesc_proveedor_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
        ...
        internal void SetTipoProveedor(string cod_tipoproveedor, string desc_tipoproveedor)
        {
            TxtCod_tipoproveedor.Text = cod_tipoproveedor;
            TxtDesc_tipoproveedor.Text = desc_tipoproveedor;
        }
        ...
        private void TxtCod_tipoproveedor_DoubleClick(object sender, EventArgs e)
        {
            FTipoProveedorLista Listado = new FTipoProveedorLista
            {
                TxtFlag = "Prov"
            };
            Dt = ETipoProveedor.Mostrar();
            if (Dt.Rows.Count == 0)
            {
                MensajeError("No Existen Registros Disponibles!");        
            }
        ...
        private void TxtCod_tipoproveedor_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F12)
            {
                FTipoProveedorLista Listado = new FTipoProveedorLista
