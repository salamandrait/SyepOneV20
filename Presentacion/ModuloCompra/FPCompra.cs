...
{
    public partial class FPCompra : Form
    {
        ...
        private static FPCompra _Instancia;

        public static FPCompra GetForm()
        {
            if (_Instancia == null)
            {
                _Instancia = new FPCompra();
            }
            return _Instancia;
        }
        ...
        internal void Limpiar()
        {
            ...
            TxtCod_pcompra.Text = string.Empty;
            TxtDesc_pcompra.Text = string.Empty;
        ...
        private void Listar()
        {
            try
            {
                DataSet DsListar = EPCompra.Listar();

                TxtCod_pcompra.Text = DsListar.Tables[0].Rows[0]["Cod_pcompra"].ToString();
                ...
                TxtDesc_pcompra.Text = DsListar.Tables[0].Rows[0]["Desc_pcompra"].ToString();
                ...
                TxtCod_pcomprav.Text = DsListar.Tables[0].Rows[0]["Cod_pcompra"].ToString();
        ...
        private void GenerarCod()
        {
            ...
            try
            {
                int rpta = Convert.ToInt32(EPCompra.GenerarCod(TxtCod_pcompra.Text));
                TxtCod_pcompra.Text = Pref + rpta.ToString(TxtCadena.Text);
            }
            catch (Exception Ex)
            {
                MensajeError(" Solo se puede Generar Codigos Numericos " + Ex.StackTrace);
                TxtCod_pcompra.Focus();
            }
        }
        ...
        {
            TxtCod_pcompra.Enabled = valor;
            TxtDesc_pcompra.Enabled = valor;
        ...
        private void FPCompra_Load(object sender, EventArgs e)
        {
        ...
        private void FPCompra_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }

        private void FPCompra_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        internal void Guardar()
        {
            try
            {
                ...
                if (TxtCod_proveedor.Text == string.Empty || TxtNumdocumento.Text == string.Empty)
                {
                    ...
                    ErrorTexto.SetError(TxtCod_pcompra, "Campo Obligatorio");
                ...
                {
                    /// <summary>
                    /// Opciones para Guardar segun sea Nuevo Registro o Edicion de Registros
                    /// </summary>
                    if (TxtEditar.Text == "Nuevo")
                    {
                        GenerarCod();
                        Rpta = EPCompra.Insertar
                            (TxtCod_pcompra.Text, TxtCod_proveedor.Text, TxtCod_condicionpago.Text, TxtDesc_pcompra.Text, TxtOptipo.Text, TxtNumdocumento.Text, TxtNumcontrol.Text, TxtDoc_asociado.Text, TxtOrigen.Text, TxtEstatus.Text, Convert.ToBoolean(TxtAnulado.Text), Convert.ToDecimal(TxtMonto_base.Text), Convert.ToDecimal(TxtMonto_r.Text), Convert.ToDecimal(TxtMonto_d.Text), Convert.ToDecimal(TxtMonto_o.Text), Convert.ToDecimal(TxtMonto_imp.Text), Convert.ToDecimal(TxtSubtotal.Text), Convert.ToDecimal(TxtTotal.Text), Convert.ToDateTime(TxtFecha_doc.Text), Convert.ToDateTime(TxtFecha_reg.Text), Convert.ToDateTime(TxtFecha_ven.Text), TxtCampo1.Text, TxtCampo2.Text, TxtCampo3.Text, TxtCampo4.Text, TxtCampo5.Text, TxtCampo6.Text, TxtCod_usuario.Text);
                        GuardarDetalle();
                        TxtCod_pcomprav.Text = TxtCod_pcompra.Text;
                        MostrarDetalle();
                        MostrarListado();
                    }
                    else if (TxtEditar.Text == "Editar")
                    {
                        Rpta = EPCompra.Editar
                            (TxtCod_pcompra.Text, TxtCod_pcomprav.Text, TxtCod_proveedor.Text, TxtCod_condicionpago.Text, TxtDesc_pcompra.Text, TxtOptipo.Text, TxtNumdocumento.Text, TxtNumcontrol.Text, TxtDoc_asociado.Text, TxtOrigen.Text, TxtEstatus.Text, Convert.ToBoolean(TxtAnulado.Text), Convert.ToDecimal(TxtMonto_base.Text), Convert.ToDecimal(TxtMonto_r.Text), Convert.ToDecimal(TxtMonto_d.Text), Convert.ToDecimal(TxtMonto_o.Text), Convert.ToDecimal(TxtMonto_imp.Text), Convert.ToDecimal(TxtSubtotal.Text), Convert.ToDecimal(TxtTotal.Text), Convert.ToDateTime(TxtFecha_doc.Text), Convert.ToDateTime(TxtFecha_reg.Text), Convert.ToDateTime(TxtFecha_ven.Text), TxtCampo1.Text, TxtCampo2.Text, TxtCampo3.Text, TxtCampo4.Text, TxtCampo5.Text, TxtCampo6.Text, TxtCod_usuario.Text);
                        TxtCod_pcomprav.Text = TxtCod_pcompra.Text;
                        MostrarDetalle();
                        MostrarListado();
                    }

                    #region REGION DE PROCESO SEGUN DOCUMENTO ASOCIADO
        ...
        private void BtnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow Row in DataListado.Rows)
                    {
                        DataTable DtStock = EStockInventario.VerificarStock(
                            Convert.ToString(Row.Cells["cod_deposito"].Value),
                            Convert.ToString(Row.Cells["cod_articulo"].Value), tipostock);
                    ...
                    EliminarRenglon();
                    Rpta = EPCompra.Eliminar(TxtCod_pcompra.Text);
            ...
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow Row in DataListado.Rows)
                    {
                        ...
                        {
                            Rpta = EPCompraDetalle.Anular(
                                Convert.ToString(Row.Cells["cod_pcompra"].Value),
                                Convert.ToString(Row.Cells["cod_deposito"].Value),
                                Convert.ToString(Row.Cells["cod_articulo"].Value),
                                Convert.ToDecimal(Row.Cells["equivalencia"].Value)
                                );
                    ...
                    Rpta = EPCompra.Anular(TxtCod_pcompra.Text, TxtEstatus.Text, Convert.ToBoolean(TxtAnulado.Text), TxtCod_usuario.Text);
        ...
        private void TxtDesc_pcompra_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }

        private void TxtCod_pcomprav_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
        ...
        private void TxtCod_pcompra_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
        ...
        private void BtnPrimero_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = EPCompra.Primero();
        ...
        private void BtnAnterior_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = EPCompra.Anterior(TxtCod_pcompra.Text);
        ...
        private void BtnSiguiente_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = EPCompra.Siguiente(TxtCod_pcompra.Text);
        ...
        private void BtnUltimo_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = EPCompra.Ultimo();
        ...
        private void OcultarColumnasGen()
        {
            ...
            DataListadoGen.Columns["cod_pcompra"].Visible = true;
            DataListadoGen.Columns["desc_pcompra"].Visible = false;
            ...
            DataListadoGen.Columns["cod_pcompra"].HeaderText = "Codigo";
        ...
        {
            DataListadoGen.DataSource = EPCompra.Mostrar();
            OcultarColumnasGen();
        ...
        private void SetPCompra()
        {
            ...
            TxtCod_pcompra.Text = Convert.ToString(DataListadoGen.CurrentRow.Cells["cod_pcompra"].Value);
            TxtDesc_pcompra.Text = Convert.ToString(DataListadoGen.CurrentRow.Cells["desc_pcompra"].Value);
        ...
        private void Buscar()
        {
            ...
            {
                DataListadoGen.DataSource = EPCompra.Buscar(TxtBuscar.Text, "cod");
            }
            else if (CbBucar.Text == "Proveedor")
            {
                DataListadoGen.DataSource = EPCompra.Buscar(TxtBuscar.Text, "Desc");
            }
            else if (CbBucar.Text == "Rif")
            {
                DataListadoGen.DataSource = EPCompra.Buscar(TxtBuscar.Text, "rif");
            }
            else if (CbBucar.Text == "Nro. Cotizacion")
            {
                DataListadoGen.DataSource = EPCompra.Buscar(TxtBuscar.Text, "num");
            }
            OcultarColumnasGen();
        }
        ...
        {
            DataListado.DataSource = EPCompraDetalle.Mostrar(TxtCod_pcompra.Text);
            OcultarColumnas();
        }
        ...
        internal void OcultarColumnas()
        {
            ...
            DataListado.Columns["cod_pcompra"].Visible = false;
        ...
        {
            DtDetalle = new DataTable("DtPCompraDetalle");

            DtDetalle.Columns.Add("reng", Type.GetType("System.Int32"));
            DtDetalle.Columns.Add("cod_pcompra", Type.GetType("System.String"));
        ...
        internal void EliminarRenglon()
        {
            foreach (DataGridViewRow Row in DataListado.Rows)
            {
                string Rpta = EPCompraDetalle.Eliminar(
                    Convert.ToInt32(Row.Cells["reng"].Value),
                    Convert.ToString(Row.Cells["cod_deposito"].Value),
                    Convert.ToString(Row.Cells["cod_articulo"].Value),
                    Convert.ToDecimal(Row.Cells["equivalencia"].Value));
            }
        ...
        public void GuardarDetalle()
        {
            try
            {
                string Rpta = "";
                Int32 _rorigen;
                string _cod_pcompra, _cod_deposito, _cod_articulo, _cod_unidad, _cod_impuesto, _optipo;
                decimal _cantidad, _equivalencia, _montound, _descuento, _descuentop, _subtotalund, _montoimp, _totalund;

                foreach (DataGridViewRow row in DataListado.Rows)
                {
                    _cod_pcompra = TxtCod_pcompra.Text;
                    ...
                    Rpta = EPCompraDetalle.Insertar(_cod_pcompra, _cod_deposito, _cod_articulo, _cod_unidad, _cod_impuesto, _optipo, _cantidad, _equivalencia, _montound, _descuento, _descuentop, _subtotalund, _montoimp, _totalund, _rorigen);
                }
            }
            catch (Exception Exc)
            {
        ...
        private void DataListado_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                string reng, cod_pcompra, cod_deposito, cod_impuesto, optipo, cod_articulo, desc_articulo, desc_deposito, cod_unidad, desc_unidad, cantidad, equivalencia, montound, descuento, descuentop, subtotalund, desc_impuesto, tasaimp, montoimp, totalund;

                if (TxtEditar.Text == "Nuevo" && TxtEstatus.Text == "Sin Procesar" && Importar == false)
                {
                    FArtCargarC mForm = FArtCargarC.GetArtCargarC();
                    mForm.TxtFlag.Text = "PCompra";
                    mForm.TxtEditar.Text = "Nuevo";
                    reng = Convert.ToString(DataListado.CurrentRow.Cells["reng"].Value);
                    cod_pcompra = Convert.ToString(DataListado.CurrentRow.Cells["cod_pcompra"].Value);
                    ...
                    QuitarRenglon();
                    mForm.SetColumnas(reng, cod_pcompra, cod_deposito, cod_impuesto, optipo, cod_articulo, desc_articulo, desc_deposito, cod_unidad, desc_unidad, cantidad, equivalencia, montound, descuento, descuentop, subtotalund, desc_impuesto, tasaimp, montoimp, totalund);
                    mForm.ShowDialog();
                }
                else if (TxtEditar.Text == "Listar" && TxtEstatus.Text == "Sin Procesar" && Importar == false)
                {
                    ...
                    mForm.TxtCod_compra.Text = TxtCod_pcompra.Text;
                    ...
                    string Rpta = EPCompraDetalle.Eliminar(
                         Convert.ToInt32(DataListado.CurrentRow.Cells["reng"].Value),
                         Convert.ToString(DataListado.CurrentRow.Cells["cod_deposito"].Value),
                         Convert.ToString(DataListado.CurrentRow.Cells["cod_articulo"].Value),
                         Convert.ToDecimal(DataListado.CurrentRow.Cells["equivalencia"].Value)
                         );
                    MostrarDetalle();
                    CalcularDetalle();
                    mForm.SetColumnas(reng, cod_pcompra, cod_deposito, cod_impuesto, optipo, cod_articulo, desc_articulo, desc_deposito, cod_unidad, desc_unidad, cantidad, equivalencia, montound, descuento, descuentop, subtotalund, desc_impuesto, tasaimp, montoimp, totalund);
        ...
        private void BtnArtCargar_Click(object sender, EventArgs e)
        {
            ...
            else if (TxtEditar.Text == "Listar")
            {
                ...
                Cargar.TxtCod_compra.Text = TxtCod_pcompra.Text;
        ...
        internal void SetImportar(string cod_proveedor, string desc_proveedor, string rif, string cod_condicionpago, string desc_condicionpago, string diascredito, string desc_pcompra, string nacional, string doc_asociado, string cod_pcompra, string fecha_doc, string fecha_ven, string campo1, string campo2, string campo3, string campo4, string campo5, string campo6)
        {
            ...
            TxtDesc_condicionpago.Text = desc_condicionpago;
            TxtDiascredito.Text = diascredito;
            TxtDesc_pcompra.Text = desc_pcompra;
            TxtNacional.Text = nacional;
            TxtDoc_asociado.Text = doc_asociado;
            TxtOrigen.Text = cod_pcompra;
        ...
        private void BtnAceptarImp_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                desc_compra = TxtDesc_pcompra.Text;
                nacional = TxtNacional.Text;
                doc_asociado = TxtOptipo.Text;
                origen = TxtCod_pcompra.Text;
