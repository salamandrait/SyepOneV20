...
{
    public partial class FTarjeta : Form
    {
        ...
        private static FTarjeta _Instancia;

        public static FTarjeta GetForm()
        {
            if (_Instancia == null)
            {
                _Instancia = new FTarjeta();
            }
            return _Instancia;
        }
        ...
        public void Listar()
        {
            try
            {
                ...
                TxtCod_tarjetav.Text = Ds.Tables[0].Rows[0]["cod_tarjeta"].ToString();
                TxtDesc_tarjeta.Text = Ds.Tables[0].Rows[0]["desc_tarjeta"].ToString();
                TxtRecargo.Text = Ds.Tables[0].Rows[0]["recargo"].ToString();
                TxtImpuesto.Text = Ds.Tables[0].Rows[0]["impuesto"].ToString();
                TxtComision.Text = Ds.Tables[0].Rows[0]["comision"].ToString();
        ...
        private void Guardar()
        {
            try
            {
                ...
                if (TxtCod_tarjeta.Text == string.Empty || TxtDesc_tarjeta.Text == string.Empty || TxtComision.Text == string.Empty || TxtRecargo.Text == string.Empty || TxtComision.Text == string.Empty)
                {
                    MensajeError("Falta ingresar algunos datos");
                    ErrorTexto.SetError(TxtCod_tarjeta, "Campo Obligatorio");
                    ErrorTexto.SetError(TxtDesc_tarjeta, "Campo Obligatorio");
                }
                else
                {
                    if (TxtEditar.Text == "Nuevo")
                    {
                        Rpta = ETarjeta.Insertar(TxtCod_tarjeta.Text.Trim().ToUpper(), TxtDesc_tarjeta.Text.Trim(), Convert.ToDecimal(TxtComision.Text), Convert.ToDecimal(TxtRecargo.Text), Convert.ToDecimal(TxtImpuesto.Text), TxtCampo1.Text, TxtCampo2.Text, TxtCampo3.Text, TxtCampo4.Text, TxtCampo5.Text, TxtCampo6.Text);
                    }
                    else if (TxtEditar.Text == "Editar")
                    {
                        Rpta = ETarjeta.Editar(TxtCod_tarjeta.Text.Trim().ToUpper(), TxtCod_tarjetav.Text.Trim().ToUpper(), TxtDesc_tarjeta.Text.Trim(), Convert.ToDecimal(TxtComision.Text), Convert.ToDecimal(TxtRecargo.Text), Convert.ToDecimal(TxtImpuesto.Text), TxtCampo1.Text, TxtCampo2.Text, TxtCampo3.Text, TxtCampo4.Text, TxtCampo5.Text, TxtCampo6.Text);
                    }
                    ...
                    if (Rpta.Equals("Y"))
                    {
                        if (TxtEditar.Text == "Nuevo")
                        {
                            ...
                            TxtEditar.Text = "Listar";
                            TxtCod_tarjetav.Text = TxtCod_tarjeta.Text;
                        }
                        else if (TxtEditar.Text == "Editar")
                        {
        ...
        private void GenerarCod()
        {
            try
            {
                int rpta = Convert.ToInt32(ETarjeta.GenerarCod(TxtCod_tarjeta.Text));
                TxtCod_tarjeta.Text = Pref + rpta.ToString(TxtCadena.Text);
            }
            catch (Exception Ex)
            {
        ...
        internal void SetTarjeta(string cod_tarjeta, string desc_tarjeta, string recargo,string impuesto,string comision,string campo1, string campo2, string campo3, string campo4, string campo5, string campo6)
        {
            TxtCod_tarjeta.Text = cod_tarjeta;
            TxtCod_tarjetav.Text = cod_tarjeta;
        ...
        private void FTarjeta_Load(object sender, EventArgs e)
        {
            Text = "...::: Tarjetas :::...";
            MostraUsuario();
            Listar();
        ...
        private void FTarjeta_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }

        private void FTarjeta_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (TxtEditar.Text == "Editar" || TxtEditar.Text == "Nuevo" && (TxtCod_tarjeta.Text != string.Empty || TxtDesc_tarjeta.Text != string.Empty || TxtComision.Text != string.Empty || TxtRecargo.Text != string.Empty || TxtComision.Text != string.Empty))
            {
        ...
        private void BtnEliminar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    Rpta = ETarjeta.Eliminar(TxtCod_tarjeta.Text);
        ...
        private void BtnAnterior_Click(object sender, EventArgs e)
        {
            try
            {
                Ds = ETarjeta.Anterior(TxtCod_tarjeta.Text);
        ...
        private void BtnSiguiente_Click(object sender, EventArgs e)
        {
            try
            {
                Ds = ETarjeta.Siguiente(TxtCod_tarjeta.Text);
        ...
        private void TxtDesc_tarjeta_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
