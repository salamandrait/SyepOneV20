...
{
    public partial class FColorLista : Form
    {
        ...
        private void OcultarColumnas()
        {
            if (DataListado.Rows.Count != 0)
            {
                ...
                DataListado.Columns["cod_color"].Visible = true;
                DataListado.Columns["desc_color"].Visible = true;
                ...
                DataListado.Columns["cod_color"].Width = 100;
                DataListado.Columns["desc_color"].Width = 350;
            ...
            {
                FColor mForm = FColor.GetForm();
                mForm.Listar();
                Close();
            }

            DataListado.Columns["cod_color"].HeaderText = "Codigo";
            DataListado.Columns["desc_color"].HeaderText = "Descripcion";
        ...
        private void Mostrar()
        {
            try
            {
                DataListado.DataSource = EColor.Mostrar();
                OcultarColumnas();
            }
            catch (Exception Exc)
            {
        ...
        private void Buscar()
        {
            ...
            {
                DataListado.DataSource = EColor.Buscar(TxtBuscar.Text, "cod");
            }
            else if (TxtBtipo.Text == "Descripcion")
            {
                DataListado.DataSource = EColor.Buscar(TxtBuscar.Text, "Desc");
            }
        }

        private void FColorListar_Load(object sender, EventArgs e)
        {
            Text = "...::: Listado :::...";
            Mostrar();
            CbBtipo();
        ...
        private void DataListado_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                FColor mForm = FColor.GetForm();
                string cod_color, desc_color, campo1, campo2, campo3, campo4, campo5, campo6;
                ...
                mForm.SetColor(cod_color, desc_color, campo1, campo2, campo3, campo4, campo5, campo6);
                mForm.TxtEditar.Text = "Listar";
            }
            if (TxtFlag == "Articulo")
            {
                FArticulo mForm = FArticulo.GetForm();
                string cod_color, desc_color;
                cod_color = Convert.ToString(DataListado.CurrentRow.Cells["cod_color"].Value);
                desc_color = Convert.ToString(DataListado.CurrentRow.Cells["desc_color"].Value);
                mForm.SetCategoria(cod_color, desc_color);
            }
            Close();
        }
            ...
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in DataListado.Rows)
                    {
                        ...
                        {
                            Rpta = EColor.Eliminar(Convert.ToString(row.Cells["cod_color"].Value));
                        }
                    }
