...
{
    public partial class FLineaLista : Form
    {
        ...
        private void OcultarColumnas()
        {
            if (DataListado.Rows.Count != 0)
            {
                ...
                DataListado.Columns["desc_linea"].Visible = true;
                ...
                DataListado.Columns["desc_linea"].Width = 350;
            ...
            {
                FLinea mForm = FLinea.GetForm();
                mForm.Listar();
                Close();
            }

            DataListado.Columns["cod_linea"].HeaderText = "Codigo";
            DataListado.Columns["desc_linea"].HeaderText = "Descripcion";
        ...
        private void FLineaListar_Load(object sender, EventArgs e)
        {
            Text = "...::: Listado :::...";
            Mostrar();
            CbBtipo();
        ...
        private void DataListado_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                FLinea mForm = FLinea.GetForm();
                string cod_linea, desc_linea, campo1, campo2, campo3, campo4, campo5, campo6;
                ...
                mForm.SetLinea(cod_linea, desc_linea, campo1, campo2, campo3, campo4, campo5, campo6);
                mForm.TxtEditar.Text = "Listar";
            }
            else if (TxtFlag == "SubLinea")
            {
                FSubLinea mForm = FSubLinea.GetForm();
                string cod_linea, desc_linea;
                cod_linea = Convert.ToString(DataListado.CurrentRow.Cells["cod_linea"].Value);
                desc_linea = Convert.ToString(DataListado.CurrentRow.Cells["desc_linea"].Value);
                mForm.SetLinea(cod_linea, desc_linea);
            }
            if (TxtFlag == "Articulo")
            {
                ...
                cod_linea = Convert.ToString(DataListado.CurrentRow.Cells["cod_linea"].Value);
                desc_linea = Convert.ToString(DataListado.CurrentRow.Cells["desc_linea"].Value);
                mForm.SetCategoria(cod_linea, desc_linea);
            }
            Close();
        }
