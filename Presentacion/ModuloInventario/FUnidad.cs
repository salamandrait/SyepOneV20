...
{
    public partial class FUnidad : Form
    {
        ...
        private static FUnidad _Instancia;

        public static FUnidad GetForm()
        {
            if (_Instancia == null)
            {
                _Instancia = new FUnidad();
            }
            return _Instancia;
        }
        ...
        internal void SetUnidad(string cod_unidad, string desc_unidad, string campo1, string campo2, string campo3, string campo4, string campo5, string campo6)
        {
            TxtCod_unidad.Text = cod_unidad;
            TxtCod_unidadv.Text = cod_unidad;
        ...
        private void FUnidad_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }

        private void FUnidad_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            //FRptUnidad Reporte = new FRptUnidad();
            //Reporte.ShowDialog();
        }
        ...
        private void BtnAnterior_Click(object sender, EventArgs e)
        {
            try
            {
                Ds = EUnidad.Anterior(TxtCod_unidad.Text);
        ...
        private void BtnSiguiente_Click(object sender, EventArgs e)
        {
            try
            {
                Ds = EUnidad.Siguiente(TxtCod_unidad.Text);
        ...
        private void TxtCod_unidad_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }

        private void TxtDesc_unidad_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
