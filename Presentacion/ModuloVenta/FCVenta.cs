...
{
    public partial class FCVenta : Form
    {
        ...
        private static FCVenta _Instancia;

        public static FCVenta GetForm()
        {
            if (_Instancia == null)
            {
                _Instancia = new FCVenta();
            }
            return _Instancia;
        }
        ...
        internal void Limpiar()
        {
            ...
            TxtCod_cventa.Text = string.Empty;
            TxtDesc_cventa.Text = string.Empty;
            TxtOptipo.Text = "CVenta";
        ...
        private void Listar()
        {
            try
            {
                DataSet DsListar = ECVenta.Listar();

                TxtCod_cventa.Text = DsListar.Tables[0].Rows[0]["Cod_cventa"].ToString();
                TxtCod_cliente.Text = DsListar.Tables[0].Rows[0]["cod_cliente"].ToString();
                TxtDesc_cliente.Text = DsListar.Tables[0].Rows[0]["desc_cliente"].ToString();
                ...
                TxtDesc_cventa.Text = DsListar.Tables[0].Rows[0]["Desc_cventa"].ToString();
                ...
                TxtCod_cventav.Text = DsListar.Tables[0].Rows[0]["Cod_cventa"].ToString();
        ...
        private void GenerarCod()
        {
            ...
            try
            {
                int rpta = Convert.ToInt32(ECVenta.GenerarCod(TxtCod_cventa.Text));
                TxtCod_cventa.Text = Pref + rpta.ToString(TxtCadena.Text);
            }
            catch (Exception Ex)
            {
        ...
        {
            TxtCod_cventa.Enabled = valor;
            TxtDesc_cventa.Enabled = valor;
        ...
        private void FCVenta_Load(object sender, EventArgs e)
        {
            Text = "...::: Cotizacion de Venta :::...";
            Listar();
            CbBtipo();
            CbBucar.Text = "Codigo";
        }

        private void FCVenta_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Instancia = null;
        }

        private void FCVenta_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        internal void Guardar()
        {
            try
            {
                ...
                if (TxtCod_cliente.Text == string.Empty || TxtNumdocumento.Text == string.Empty)
                {
                ...
                else if (registrar)
                {
                    ...
                    {
                        Rpta = ECVenta.Editar
                            (TxtCod_cventa.Text, TxtCod_cventav.Text, TxtCod_cliente.Text, TxtCod_condicionpago.Text, TxtDesc_cventa.Text, TxtOptipo.Text, TxtNumdocumento.Text, TxtNumcontrol.Text, TxtDoc_asociado.Text, TxtOrigen.Text, TxtEstatus.Text, Convert.ToBoolean(TxtAnulado.Text), Convert.ToDecimal(TxtMonto_base.Text), Convert.ToDecimal(TxtMonto_r.Text), Convert.ToDecimal(TxtMonto_d.Text), Convert.ToDecimal(TxtMonto_o.Text), Convert.ToDecimal(TxtMonto_imp.Text), Convert.ToDecimal(TxtSubtotal.Text), Convert.ToDecimal(TxtTotal.Text), Convert.ToDateTime(TxtFecha_doc.Text), Convert.ToDateTime(TxtFecha_reg.Text), Convert.ToDateTime(TxtFecha_ven.Text), TxtCampo1.Text, TxtCampo2.Text, TxtCampo3.Text, TxtCampo4.Text, TxtCampo5.Text, TxtCampo6.Text, TxtCod_usuario.Text);
                        TxtCod_cventav.Text = TxtCod_cventa.Text;
                        MostrarDetalle();
                        MostrarListado();
                    }

                    if (TxtDoc_asociado.Text == "CVenta")
                    {
                        ...
                        if (Opcion == DialogResult.OK)
                        {
                            ...
                            {
                                Rpta = ECVentaDetalle.Importar(Convert.ToInt32(Row.Cells["rorigen"].Value));

                                DataTable DtD = ECVentaDetalle.Mostrar(TxtOrigen.Text);
                                ...
                                {
                                    Rpta = ECVenta.Procesar(TxtOrigen.Text, "Procesado", TxtCod_usuario.Text);
                                }
                                else if (Validar1 < Validar2)
                                {
                                    Rpta = ECVenta.Procesar(TxtOrigen.Text, "Procesado Parcial", TxtCod_usuario.Text);
                                }
                            }
                        }
            ...
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    if (TxtDoc_asociado.Text == "CVenta")
                    {
                        foreach (DataGridViewRow Row in DataListado.Rows)
                        {
                            Rpta = ECVentaDetalle.EliminarImportar(Convert.ToInt32(Row.Cells["rorigen"].Value));
                            ...
                            if (Validar2 == Validar1)
                            {
                                Rpta = ECVenta.Procesar(TxtOrigen.Text, "Sin Procesar", TxtCod_usuario.Text);
                            }
                            else if (Validar1 < Validar2)
                            {
                                Rpta = ECVenta.Procesar(TxtOrigen.Text, "Procesado Parcial", TxtCod_usuario.Text);
                    ...
                    EliminarRenglon();
                    Rpta = ECVenta.Eliminar(TxtCod_cventa.Text);
            ...
            try
            {
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow Row in DataListado.Rows)
                    {
                        ...
                        {
                            Rpta = ECVentaDetalle.Anular(Convert.ToString(Row.Cells["cod_cventa"].Value));
                        }
                    }

                    Rpta = ECVenta.Anular(TxtCod_cventa.Text, TxtEstatus.Text, Convert.ToBoolean(TxtAnulado.Text), TxtCod_usuario.Text);
        ...
        private void TxtDesc_cventa_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }

        private void TxtCod_cventav_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
        ...
        private void TxtCod_cventa_TextChanged(object sender, EventArgs e)
        {
            CambiosTexBox();
        }
        ...
        {
            if (TxtOptipo.Text == "CVenta")
            {
                BtnPagar.Text = "Facturar";
            }
            else if (TxtOptipo.Text == "PVenta")
            {
                BtnPagar.Text = "Facturar";
            }
            else if (TxtOptipo.Text == "FVenta")
            {
                BtnPagar.Text = "Pagar";
            }
        }

        private void TxtCod_cliente_Validating(object sender, CancelEventArgs e)
        {
            DataTable Dt = ECVenta.Mostrar();
            if (TxtEditar.Text == "Editar" || TxtEditar.Text == "Nuevo")
            {
                foreach (DataRow row in Dt.Rows)
                {
                    if (Convert.ToString(row["numdocumento"].ToString()).Equals(TxtNumdocumento.Text) &&
                        Convert.ToString(row["cod_cliente"].ToString()).Equals(TxtCod_cliente.Text))
                    {
                        MensajeError("Numero de Documento Duplicado para el Cliente en Proceso");
        ...
        internal void SetCliente(string cod_cliente, string desc_cliente, string rif, string nacional, string cod_condicionpago, string desc_condicionpago, string diascredito)
        {
        ...
        private void TxtCod_cliente_DoubleClick(object sender, EventArgs e)
        {
        ...
        private void TxtCod_cliente_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void BtnPrimero_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = ECVenta.Primero();
        ...
        private void BtnAnterior_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = ECVenta.Anterior(TxtCod_cventa.Text);
        ...
        private void BtnSiguiente_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = ECVenta.Siguiente(TxtCod_cventa.Text);
        ...
        private void BtnUltimo_Click(object sender, EventArgs e)
        {
            try
            {
                DataSet DsListar = ECVenta.Ultimo();
        ...
        private void OcultarColuumnasGen()
        {
            ...
            DataListadoGen.Columns["cod_cliente"].Visible = false;
            DataListadoGen.Columns["desc_cliente"].Visible = true;
            ...
            DataListadoGen.Columns["cod_cventa"].Visible = true;
            DataListadoGen.Columns["desc_cventa"].Visible = false;
            ...
            DataListadoGen.Columns["cod_cventa"].HeaderText = "Codigo";
            DataListadoGen.Columns["desc_cliente"].HeaderText = "Cliente";
            ...
            DataListadoGen.Columns["desc_cliente"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            ...
            DataListadoGen.Columns["desc_cliente"].Width = 250;
        ...
        {
            DataListadoGen.DataSource = ECVenta.Mostrar();
            OcultarColuumnasGen();
        ...
        private void SetCVenta()
        {
            TxtNacional.Text = Convert.ToString(DataListadoGen.CurrentRow.Cells["nacional"].Value);
            TxtCod_cliente.Text = Convert.ToString(DataListadoGen.CurrentRow.Cells["cod_cliente"].Value);
            TxtDesc_cliente.Text = Convert.ToString(DataListadoGen.CurrentRow.Cells["desc_cliente"].Value);
            ...
            TxtCod_cventa.Text = Convert.ToString(DataListadoGen.CurrentRow.Cells["cod_cventa"].Value);
            TxtDesc_cventa.Text = Convert.ToString(DataListadoGen.CurrentRow.Cells["desc_cventa"].Value);
        ...
        private void Buscar()
        {
            ...
            {
                DataListadoGen.DataSource = ECVenta.Buscar(TxtBuscar.Text, "cod");
            }
            else if (CbBucar.Text == "Cliente")
            {
                DataListadoGen.DataSource = ECVenta.Buscar(TxtBuscar.Text, "Desc");
            }
            else if (CbBucar.Text == "Rif")
            {
                DataListadoGen.DataSource = ECVenta.Buscar(TxtBuscar.Text, "rif");
            }
            else if (CbBucar.Text == "Nro. Cotizacion")
            {
                DataListadoGen.DataSource = ECVenta.Buscar(TxtBuscar.Text, "num");
            }
            OcultarColuumnasGen();
        }
        ...
        {
            DataListado.DataSource = ECVentaDetalle.Mostrar(TxtCod_cventa.Text);
            OcultarColumnas();
        }
        ...
        internal void OcultarColumnas()
        {
            ...
            DataListado.Columns["cod_cventa"].Visible = false;
        ...
        {
            DtDetalle = new DataTable("DtCVentaDetalle");

            DtDetalle.Columns.Add("reng", Type.GetType("System.Int32"));
            DtDetalle.Columns.Add("cod_cventa", Type.GetType("System.String"));
        ...
        internal void EliminarRenglon()
        {
            foreach (DataGridViewRow Row in DataListado.Rows)
            {
                string Rpta = ECVentaDetalle.Eliminar(Convert.ToInt32(Row.Cells["reng"].Value));
            }
        }
        ...
        public void GuardarDetalle()
        {
            try
            {
                string Rpta = "";
                Int32 _rorigen;
                string _cod_cventa, _cod_deposito, _cod_articulo, _cod_unidad, _cod_impuesto, _optipo;
                decimal _cantidad, _equivalencia, _montound, _descuento, _descuentop, _subtotalund, _montoimp, _totalund;

                foreach (DataGridViewRow row in DataListado.Rows)
                {
                    _cod_cventa = TxtCod_cventa.Text;
                    ...
                    Rpta = ECVentaDetalle.Insertar(_cod_cventa, _cod_deposito, _cod_articulo, _cod_unidad, _cod_impuesto, _optipo, _cantidad, _equivalencia, _montound, _descuento, _descuentop, _subtotalund, _montoimp, _totalund, _rorigen);
                }
            }
            catch (Exception Exc)
            {
                    ...
                    else if (DataListado.Rows.Count > 1)
                    {
                        ...
                        if (Opcion == DialogResult.OK)
                        {
                            ...
                            foreach (DataGridViewRow Row in DataListado.Rows)
                            {
                                ...
                                {
                                    Rpta = ECVentaDetalle.Eliminar(Convert.ToInt32(Row.Cells["reng"].Value));
                                }
                            }
        ...
        private void DataListado_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                string reng, cod_cventa, cod_deposito, cod_impuesto, optipo, cod_articulo, desc_articulo, desc_deposito, cod_unidad, desc_unidad, cantidad, equivalencia, montound, descuento, descuentop, subtotalund, desc_impuesto, tasaimp, montoimp, totalund;

                if (TxtEditar.Text == "Nuevo" && TxtEstatus.Text == "Sin Procesar" && Importar == false)
                {
                    FArtCargarC mForm = FArtCargarC.GetArtCargarC();
                    mForm.TxtFlag.Text = "CVenta";
                    mForm.TxtEditar.Text = "Nuevo";
                    reng = Convert.ToString(DataListado.CurrentRow.Cells["reng"].Value);
                    cod_cventa = Convert.ToString(DataListado.CurrentRow.Cells["cod_cventa"].Value);
                    ...
                    QuitarRenglon();
                    mForm.SetColumnas(reng, cod_cventa, cod_deposito, cod_impuesto, optipo, cod_articulo, desc_articulo, desc_deposito, cod_unidad, desc_unidad, cantidad, equivalencia, montound, descuento, descuentop, subtotalund, desc_impuesto, tasaimp, montoimp, totalund);
                    mForm.ShowDialog();
                }
                else if (TxtEditar.Text == "Listar" && TxtEstatus.Text == "Sin Procesar" && Importar == false)
                {
                    ...
                    mForm.TxtCod_venta.Text = TxtCod_cventa.Text;
                    ...
                    string Rpta = ECVentaDetalle.Eliminar(Convert.ToInt32(DataListado.CurrentRow.Cells["reng"].Value));
                    MostrarDetalle();
                    CalcularDetalle();
                    mForm.SetColumnas(reng, cod_cventa, cod_deposito, cod_impuesto, optipo, cod_articulo, desc_articulo, desc_deposito, cod_unidad, desc_unidad, cantidad, equivalencia, montound, descuento, descuentop, subtotalund, desc_impuesto, tasaimp, montoimp, totalund);
                    mForm.ShowDialog();
        ...
        private void BtnArtCargar_Click(object sender, EventArgs e)
        {
            ...
            else if (TxtEditar.Text == "Listar")
            {
                ...
                Cargar.TxtCod_venta.Text = TxtCod_cventa.Text;
        ...
        #region IMPORTAR
        internal void SetImportar(string cod_cliente, string desc_cliente, string rif, string cod_condicionpago, string desc_condicionpago, string diascredito, string desc_cventa, string nacional, string doc_asociado, string cod_cventa, string fecha_doc, string fecha_ven, string campo1, string campo2, string campo3, string campo4, string campo5, string campo6)
        {
            TxtCod_cliente.Text = cod_cliente;
            TxtDesc_cliente.Text = desc_cliente;
            TxtRif.Text = rif;
            ...
            TxtDesc_condicionpago.Text = desc_condicionpago;
            TxtDiascredito.Text = diascredito;
            TxtDesc_cventa.Text = desc_cventa;
            TxtNacional.Text = nacional;
            TxtDoc_asociado.Text = doc_asociado;
            TxtOrigen.Text = cod_cventa;
        ...
        private void BtnAceptarImp_Click(object sender, EventArgs e)
        {
            ...
            {
                #region PARAMETROS
                string cod_cliente, desc_cliente, rif, cod_condicionpago, desc_condicionpago, diascredito, desc_venta, nacional, doc_asociado, origen, monto_base, monto_r, monto_d, monto_o, monto_imp, subtotal, total, fecha_doc, fecha_ven, campo1, campo2, campo3, campo4, campo5, campo6;
                ...
                FCVenta ImpC = GetForm();
                FPVenta ImpP = FPVenta.GetForm();
                FFVenta ImpF = FFVenta.GetForm();

                if (TipoImp == "FVenta" && Importar == true)
                {
                    if (ImpF.TxtCod_cliente.Text == String.Empty)
                    {
                        ImpF.SetImportar(cod_cliente, desc_cliente, rif, cod_condicionpago, desc_condicionpago, diascredito, desc_venta, nacional, doc_asociado, origen, fecha_doc, fecha_ven, campo1, campo2, campo3, campo4, campo5, campo6);
                    }
                ...
                else if (TipoImp == "CVenta" && Importar == true)
                {
                    if (ImpC.TxtCod_cliente.Text == String.Empty)
                    {
                        ImpC.SetImportar(cod_cliente, desc_cliente, rif, cod_condicionpago, desc_condicionpago, diascredito, desc_venta, nacional, doc_asociado, origen, fecha_doc, fecha_ven, campo1, campo2, campo3, campo4, campo5, campo6);
                    }
                ...
                else if (TipoImp == "PVenta" && Importar == true)
                {
                    if (ImpP.TxtCod_cliente.Text == String.Empty)
                    {
                        ImpP.SetImportar(cod_cliente, desc_cliente, rif, cod_condicionpago, desc_condicionpago, diascredito, desc_venta, nacional, doc_asociado, origen, fecha_doc, fecha_ven, campo1, campo2, campo3, campo4, campo5, campo6);
                    }
