...
namespace Entidades
{
    public class EPago
    {
        public static string Insertar(string cod_pago, string cod_proveedor, string desc_pago, string estatus, bool anulado, decimal monto, DateTime fecha_reg, string campo1, string campo2, string campo3, string campo4, string campo5, string campo6, string cod_usuario)
        {
            DPago Obj = new DPago
            {
                Dcod_pago = cod_pago,
        ...
        public static string Editar(string cod_pago, string cod_pagov, string cod_proveedor, string desc_pago, string estatus, bool anulado, decimal monto, DateTime fecha_reg, string campo1, string campo2, string campo3, string campo4, string campo5, string campo6, string cod_usuario)
        {
            DPago Obj = new DPago
            {
                Dcod_pago = cod_pago,
        ...
        public static string Anular(string cod_pago, string estatus, bool anulado, string cod_usuario)
        {
            DPago Obj = new DPago()
            {
                Dcod_pago = cod_pago,
        ...
        public static DataTable MostrarSaldo(string cod_proveedor)
        {
            DPago Obj = new DPago()
            {
                Dcod_proveedor = cod_proveedor,
            };
            return Obj.MostrarSaldo(Obj);
        }
